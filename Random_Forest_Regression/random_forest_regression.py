# rassal orman kollektif öğrenmedir.
import pandas as pd
...
rf_reg = RandomForestRegressor(n_estimators=10, random_state=0)  # n_est = kaç tane decision tree çizileceği
rf_reg.fit(X, Y)

print("Random Forest", rf_reg.predict([[6.5]]))
plt.scatter(X, Y, color="red")
